...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--team', type=str, help='Three letter abbreviation for team.',
        required=True)
    parser.add_argument(
        '--first_year', type=int, help='First year of interest (e.g., 2005).',
        required=True)
    parser.add_argument(
        '--last_year', type=int, help='Last year of interest (e.g., 2012).',
        required=True)
